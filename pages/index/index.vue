    ...
    <section class="relative bg-system-primary-10">
      ...
      >
        <div class="w-[8.75rem] space-y-6 xl:space-y-10">
          ...
          <div
            class="h-[0.125rem] rounded-full bg-gradient-to-r from-system-primary-100 to-white"
          />
        </div>
        <ul class="space-y-10">
          <li
